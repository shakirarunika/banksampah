                ...
                <form wire:submit="importExcel" class="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto"
                    ...
                    <div class="relative w-full sm:w-64">
                        ...
                        <label for="file_import"
                            class="flex items-center justify-center gap-2 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl cursor-pointer hover:bg-emerald-50 hover:border-emerald-300 transition-all shadow-sm group">
                            {{-- Ikon file --}}
                            <svg class="w-4 h-4 text-slate-400 group-hover:text-emerald-500 flex-shrink-0 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-[10px] font-black text-slate-500 uppercase truncate max-w-[160px]" x-text="fileName">
                                Pilih File Excel...
                            </span>
                        </label>
                        @error('file_import')
                            <p class="mt-1 text-[10px] text-red-500 font-bold text-center">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        @can('access-admin')
            <div class="mt-4 text-right">
                <button
                    ...
                    wire:confirm="⚠️ YAKIN MAU HAPUS SEMUA DATA? Aksi ini permanen dan akan menghanguskan semua saldo karyawan!"
